...
//
//------------------------------------------------------------------------
CXAudioSource::CXAudioSource(CXAudio*	pXAudio, TCHAR* szFileName, DWORD dwNum)
{
	ZeroMemory(this, sizeof(CXAudioSource));
	m_pXAudio = pXAudio;
...
//
//------------------------------------------------------------------------
HRESULT CXAudioSource::Load(TCHAR* szFileName, DWORD dwNum)
{
	TCHAR ext[50];
...
//
//------------------------------------------------------------------------
HRESULT CXAudioSource::LoadAudio(TCHAR* szFileName, DWORD dwSourceNum)
{
...
//
//------------------------------------------------------------------------
HRESULT CXAudioSource::LoadMci(TCHAR* szFileName)
{
	TCHAR AllStr[512];
	TCHAR exe[265];
