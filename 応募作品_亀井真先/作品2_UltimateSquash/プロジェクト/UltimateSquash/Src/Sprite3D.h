...
public:
	...
	CSpriteImage*  GetImage() {return m_pImage;}
...
public:
	...
	void FreamDraw(float posX, float posY, TCHAR* text, int fontsize, DWORD colorABGR, float fAlpha = 1.0f, TCHAR* szFontName = NULL);
