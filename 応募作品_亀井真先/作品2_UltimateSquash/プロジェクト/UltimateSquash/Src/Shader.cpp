...
CShader::~CShader()
{
	...
	// Fbxモデル　スタティツクメッシュ用のシェーダー
	// トゥーンシェーディング用
	SAFE_RELEASE(m_pFbxStaticMeshToon_VS_TOON1);
	SAFE_RELEASE(m_pFbxStaticMeshToon_PS_TOON1);
	SAFE_RELEASE(m_pFbxStaticMeshToon_VS_TOON2);
	SAFE_RELEASE(m_pFbxStaticMeshToon_PS_TOON2);

	// Fbxモデル　スキンメッシュ用のシェーダー
	// トゥーンシェーディング用
	SAFE_RELEASE(m_pFbxSkinMeshToon_VS_TOON1);
	SAFE_RELEASE(m_pFbxSkinMeshToon_PS_TOON1);
	SAFE_RELEASE(m_pFbxSkinMeshToon_VS_TOON2);
	SAFE_RELEASE(m_pFbxSkinMeshToon_PS_TOON2);

	//--2022.02.2.7:30
	// Fbxモデル　スタティツクメッシュ用のシェーダー
//残像シェーディング用
	SAFE_RELEASE(m_pFbxStaticMeshAfter_VS_AFTER1);
	SAFE_RELEASE(m_pFbxStaticMeshAfter_PS_AFTER1);
	SAFE_RELEASE(m_pFbxStaticMeshAfter_VS_AFTER2);
	SAFE_RELEASE(m_pFbxStaticMeshAfter_PS_AFTER2);

	//--2022.02.2.7:30
	// Fbxモデル　スキンメッシュ用のシェーダー
	// 残像シェーディング用
	SAFE_RELEASE(m_pFbxSkinMeshAfter_VS_AFTER1);
	SAFE_RELEASE(m_pFbxSkinMeshAfter_PS_AFTER1);
	SAFE_RELEASE(m_pFbxSkinMeshAfter_VS_AFTER2);
	SAFE_RELEASE(m_pFbxSkinMeshAfter_PS_AFTER2);


	// MPR用のシェーダー	//--2022.01.28.2300
	SAFE_RELEASE(m_pMPR_VertexLayout);
	SAFE_RELEASE(m_pMPR_VS);
	SAFE_RELEASE(m_pMPR_PS);
	...
	SAFE_RELEASE(m_pConstantBufferMPR);	//--2022.01.28.2300
...
HRESULT CShader::InitShader()
{
	...
	//  Fbxスタティック・スキンメッシュ(トゥーンシェーディング)用のシェーダー作成	//--2022.01.28.2300
	InitShaderFbxToon();

	//  Fbxスタティック・スキンメッシュ(残像)用のシェーダー作成	//--2022.02.2.7:30
	InitShaderFbxAfter();


	//  MPR用のシェーダー作成	//--2022.01.28.2300
	InitShaderMPR();
...
//
//------------------------------------------------------------------------
HRESULT CShader::InitShaderFbxToon()
{

	// -------------------------------------------------------------------
	// 
	// スタティックメッシュ  FbxStaticMeshToon
	// 
	// -------------------------------------------------------------------
	// バーテックスシェーダ・ピクセルシェーダの作成
	MakeShader(_T("VS"), _T("FbxStaticMeshToon_VS_TOON1.cso"), (void**)&m_pFbxStaticMeshToon_VS_TOON1);
	MakeShader(_T("VS"), _T("FbxStaticMeshToon_VS_TOON2.cso"), (void**)&m_pFbxStaticMeshToon_VS_TOON2);
	MakeShader(_T("PS"), _T("FbxStaticMeshToon_PS_TOON1.cso"), (void**)&m_pFbxStaticMeshToon_PS_TOON1);
	MakeShader(_T("PS"), _T("FbxStaticMeshToon_PS_TOON2.cso"), (void**)&m_pFbxStaticMeshToon_PS_TOON2);

	// -------------------------------------------------------------------
	// 
	// スキンメッシュ  FbxSkinMeshToon
	// 
	// -------------------------------------------------------------------
	// バーテックスシェーダ・ピクセルシェーダの作成
	MakeShader(_T("VS"), _T("FbxSkinMeshToon_VS_TOON1.cso"), (void**)&m_pFbxSkinMeshToon_VS_TOON1);
	MakeShader(_T("VS"), _T("FbxSkinMeshToon_VS_TOON2.cso"), (void**)&m_pFbxSkinMeshToon_VS_TOON2);
	MakeShader(_T("PS"), _T("FbxSkinMeshToon_PS_TOON1.cso"), (void**)&m_pFbxSkinMeshToon_PS_TOON1);
	MakeShader(_T("PS"), _T("FbxSkinMeshToon_PS_TOON2.cso"), (void**)&m_pFbxSkinMeshToon_PS_TOON2);

	return S_OK;
}

HRESULT CShader::InitShaderFbxAfter()
{
	//--2022.02.2.7:30
	...
	// -------------------------------------------------------------------
	// バーテックスシェーダ・ピクセルシェーダの作成
	MakeShader(_T("VS"), _T("FbxStaticMeshAfter_VS_AFTER1.cso"), (void**)&m_pFbxStaticMeshAfter_VS_AFTER1);
	MakeShader(_T("VS"), _T("FbxStaticMeshAfter_VS_AFTER2.cso"), (void**)&m_pFbxStaticMeshAfter_VS_AFTER2);
	MakeShader(_T("PS"), _T("FbxStaticMeshAfter_PS_AFTER1.cso"), (void**)&m_pFbxStaticMeshAfter_PS_AFTER1);
	MakeShader(_T("PS"), _T("FbxStaticMeshAfter_PS_AFTER2.cso"), (void**)&m_pFbxStaticMeshAfter_PS_AFTER2);
	...
	// -------------------------------------------------------------------
	// バーテックスシェーダ・ピクセルシェーダの作成
	MakeShader(_T("VS"), _T("FbxSkinMeshAfter_VS_AFTER1.cso"), (void**)&m_pFbxSkinMeshAfter_VS_AFTER1);
	MakeShader(_T("VS"), _T("FbxSkinMeshAfter_VS_AFTER2.cso"), (void**)&m_pFbxSkinMeshAfter_VS_AFTER2);
	MakeShader(_T("PS"), _T("FbxSkinMeshAfter_PS_AFTER1.cso"), (void**)&m_pFbxSkinMeshAfter_PS_AFTER1);
	MakeShader(_T("PS"), _T("FbxSkinMeshAfter_PS_AFTER2.cso"), (void**)&m_pFbxSkinMeshAfter_PS_AFTER2);
...
//
//------------------------------------------------------------------------
HRESULT CShader::InitShaderMPR()
{
	// 頂点インプットレイアウトを定義	
	D3D11_INPUT_ELEMENT_DESC layout_MPR[] =
	{
		{ "POSITION", 0, DXGI_FORMAT_R32G32B32_FLOAT, 0, 0, D3D11_INPUT_PER_VERTEX_DATA, 0 },
		{ "TEXCOORD", 0, DXGI_FORMAT_R32G32_FLOAT, 0, 12, D3D11_INPUT_PER_VERTEX_DATA, 0 },
	};
	UINT numElements = sizeof(layout_MPR) / sizeof(layout_MPR[0]);

	// バーテックスシェーダ・ピクセルシェーダ・頂点インプットレイアウトの作成
	MakeShader(_T("VS"), _T("MPR_VS.cso"), (void**)&m_pMPR_VS, layout_MPR, numElements, &m_pMPR_VertexLayout);
	MakeShader(_T("PS"), _T("MPR_PS.cso"), (void**)&m_pMPR_PS);
...
HRESULT CShader::InitShaderConstant()
{
	...
	// MPRコンスタントバッファー作成　ここでは変換行列渡し用	//--2022.01.28.2300
	MakeConstantBuffer(sizeof(CONSTANT_BUFFER_MPR), &m_pConstantBufferMPR);
