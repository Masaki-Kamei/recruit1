...
//
//------------------------------------------------------------------------ 
void CFontTexture::FreamDraw(float posX, float posY, TCHAR* szText, int fontsize, DWORD colorABGR, float fAlpha, TCHAR* szFontName)
{
	MATRIX4X4 mWorld;
	mWorld = XMMatrixTranslation(posX+1, posY+1, 0.0f);
	Draw(mWorld, szText, fontsize, colorABGR, fAlpha, szFontName);
	mWorld = XMMatrixTranslation(posX+1, posY-1, 0.0f);
	Draw(mWorld, szText, fontsize, colorABGR, fAlpha, szFontName);
	mWorld = XMMatrixTranslation(posX-1, posY+1, 0.0f);
